(function () {
  ...
  function openStory(id,resetScroll=true){const s=storyById.get(id);if(!s)return;activeDetail={kind:"story",id};$("drawerId").textContent=`${s.id} · ${t(s.sourceGroupName)} · ${priorityLabel(s.priority)}`;

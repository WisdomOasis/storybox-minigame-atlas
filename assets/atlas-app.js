(function () {
  ...
  document.addEventListener("error",event=>{const image=event.target;if(!(image instanceof HTMLImageElement)||!image.matches("[data-story-cover]"))return;image.hidden=true;image.closest(".story-cover")?.classList.add("cover-fallback");},true);
  applyLanguage();
})();
